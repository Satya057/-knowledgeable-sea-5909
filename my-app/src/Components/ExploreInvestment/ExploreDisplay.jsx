...
function ExploreDisplay() {
  const initState = {images:[""],AboutProject:"",title:"",ProjectBy:"",location:"",startingPrice:"",homes:"",targetYeild:"",targetIrr:"",id:""}
   const [data , setData] = useState(initState)
    ...
    return (
    <>
    <Box w="100%" py="50px" color="white" filter='grayscale(40%)' minH="500px" backgroundSize="cover" backgroundImage={`linear-gradient(-180deg,transparent 10%,rgba(0,0,0,.9)),url('${data.images[0]}')`} >
             ...
             <Button mt="30px" colorScheme='orange'>Contact Us</Button>
              <Divider my="50px"/>
              ...
              <SimpleGrid mx="30px" columns={{lg:5,md:4,sm:2,base:2}}>
                ...
                <Box textAlign='center'>
                  ...
                  <Text fontSize='1.1em' color='grey'>Date Of Completion | Phase 2</Text>
                </Box>
               
              </SimpleGrid>
                
    </Box>
    <Text fontSize='2.5em' mt="50px" fontWeight="semibold">Photos</Text>
     ...
     <SimpleGrid width="80%" m='auto' my="50px"  columns={4}>
      {data.images.map((e ,i)=>{
        ...
        if(i>=8){
          ...
          return <ImageVeiwer images={data.images} count={i}/>
